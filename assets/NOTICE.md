...
### 2. Protocol Version Translation (ViaVersion / ViaBackwards / ViaRewind)
...
### 4. Pumpkin Source Code & Plugin API
...
* **Plugin API**: The `papokin-plugin-api` and `papokin-plugin-wit` crates are dual-licensed under **MIT OR Apache-2.0** to allow plugin authors to use their preferred license.
