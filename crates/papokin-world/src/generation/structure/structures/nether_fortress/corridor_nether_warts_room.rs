...
use papokin_util::{BlockDirection, math::block_box::BlockBox, random::RandomGenerator};
...
impl StructurePieceBase for CorridorNetherWartsRoomPiece {
    ...
    fn place(
        ...
        let stair_n =
            papokin_data::BlockState::from_id(stair_props.to_state_id(&Block::NETHER_BRICK_STAIRS));
