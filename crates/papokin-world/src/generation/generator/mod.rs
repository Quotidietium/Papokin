...
use papokin_data::noise_router::BaseNoiseRouters;
...
use papokin_data::structures::{StructurePlacementCalculator, StructureSet};
...
impl WorldGenerator {
    ...
    #[must_use]
    pub fn find_spawn_position(&self) -> papokin_util::math::position::BlockPos {
        match self {
            Self::Noise(noise_gen) => noise_gen.find_spawn_position(),
            _ => papokin_util::math::position::BlockPos::ZERO,
        }
    }
}
...
impl VanillaGenerator {
    ...
    pub fn find_spawn_position(&self) -> papokin_util::math::position::BlockPos {
        if self.settings.spawn_target.is_empty() {
            return papokin_util::math::position::BlockPos::ZERO;
        }
        let mut sampler =
    ...
    pub fn new_with_all_settings(
        ...
        if dimension == Dimension::OVERWORLD {
            let papokin_data::structures::StructurePlacementType::ConcentricRings(rings) =
