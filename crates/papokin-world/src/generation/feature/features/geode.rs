...
use papokin_data::{Block, BlockDirection, BlockId, BlockState, BlockStateId};
use papokin_util::{
...
/// 对用于晶洞生成的 perlin 采样器的极简封装，以避免向此文件暴露整个噪声模块。
                ...
                for dir in &BlockDirection::all() {
                    ...
                    if is_air || is_water {
                        ...
                        let dir_name = match dir {
                            papokin_data::BlockDirection::Up => "up",
                            papokin_data::BlockDirection::Down => "down",
                            papokin_data::BlockDirection::North => "north",
                            papokin_data::BlockDirection::South => "south",
                            papokin_data::BlockDirection::East => "east",
                            papokin_data::BlockDirection::West => "west",
                        };
