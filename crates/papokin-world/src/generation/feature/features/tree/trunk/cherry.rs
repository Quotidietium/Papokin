...
use papokin_util::math::int_provider::{IntProvider, UniformIntProvider};
...
use papokin_data::block_properties::{Axis, PaleOakWoodLikeProperties};
...
impl CherryTrunkPlacer {
    ...
    pub fn generate<T: GenerationCache>(
        ...
        let directions = [
            BlockPos::new(0, 0, -1), // 北
            BlockPos::new(0, 0, 1),  // 南
            BlockPos::new(-1, 0, 0), // 西
            BlockPos::new(1, 0, 0),  // 东
        ];
