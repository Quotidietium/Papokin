...
use papokin_data::{Block, BlockId, BlockState, block_properties::is_air};
use papokin_util::{
                ...
                for y_off in 0..=height {
                    ...
                    if Self::is_iceberg_state(bid) || bid == Block::SNOW.id {
                        ...
                        if is_air(below_state_id) {
                            ...
                            let sides = [
                                pos.add(&Vector3::new(-1, 0, 0)), // 西
                                pos.add(&Vector3::new(1, 0, 0)),  // 东（east）
                                pos.add(&Vector3::new(0, 0, -1)), // 北
                                pos.add(&Vector3::new(0, 0, 1)),  // 南
                            ];
