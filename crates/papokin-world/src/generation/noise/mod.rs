...
use papokin_data::{Block, BlockState, noise_settings::GenerationShapeConfig};
use papokin_util::{math::vector3::Vector3, random::xoroshiro128::XoroshiroSplitter};
...
impl<'a> ChunkNoiseGenerator<'a> {
    ...
    pub fn new(
        ...
        >,
        affected_box: Option<papokin_util::math::block_box::BlockBox>,
    ) -> Self {
