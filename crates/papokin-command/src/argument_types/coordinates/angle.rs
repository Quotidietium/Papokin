...
pub const ERROR_NOT_COMPLETE: CommandErrorType<0> =
    CommandErrorType::new(translation::java::ARGUMENT_ANGLE_INCOMPLETE);

pub const ERROR_INVALID_ANGLE: CommandErrorType<0> =
    CommandErrorType::new(translation::java::ARGUMENT_ANGLE_INVALID);
