...
use papokin_data::tag::{RegistryKey, get_tag_ids};
use papokin_data::{Block, translation};
...
pub const ERROR_UNKNOWN_TAG: CommandErrorType<1> =
    CommandErrorType::new(translation::java::ARGUMENTS_BLOCK_TAG_UNKNOWN);

pub const ERROR_NO_VALUE: CommandErrorType<1> =
    CommandErrorType::new(translation::java::ARGUMENT_BLOCK_PROPERTY_NOVALUE);

pub const ERROR_UNCLOSED_PROPERTIES: CommandErrorType<0> =
    CommandErrorType::new(translation::java::ARGUMENT_BLOCK_PROPERTY_UNCLOSED);
