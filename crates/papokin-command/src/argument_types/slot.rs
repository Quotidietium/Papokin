...
use papokin_data::slot_ranges::{
    SLOT_RANGE_ALL_NAMES, SLOT_RANGE_SINGLE_SLOT_NAMES, get_slot_range,
};
use papokin_data::translation;
use papokin_util::text::TextComponent;

pub const UNKNOWN_SLOT_ERROR_TYPE: CommandErrorType<1> =
    CommandErrorType::new(translation::java::SLOT_UNKNOWN);

pub const ONLY_SINGLE_SLOT_ALLOWED_ERROR_TYPE: CommandErrorType<1> =
    CommandErrorType::new(translation::java::SLOT_ONLY_SINGLE_ALLOWED);
