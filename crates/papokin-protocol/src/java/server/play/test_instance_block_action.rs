use papokin_data::packet::serverbound::play::TEST_INSTANCE_BLOCK_ACTION;
...
pub struct TestInstanceBlockData<'a> {
    ...
    pub rotation: papokin_data::block_rotation::Rotation,
...
impl<'a> TestInstanceBlockData<'a> {
    fn read(bytebuf: &mut &'a [u8]) -> Result<Self, ReadingError> {
        ...
        let rotation = match bytebuf.get_var_int()?.0 {
            0 => papokin_data::block_rotation::Rotation::None,
            1 => papokin_data::block_rotation::Rotation::Clockwise90,
            2 => papokin_data::block_rotation::Rotation::Rotate180,
            3 => papokin_data::block_rotation::Rotation::CounterClockwise90,
    ...
    fn write(
        ...
        let rot_val = match self.rotation {
            papokin_data::block_rotation::Rotation::None => 0,
            papokin_data::block_rotation::Rotation::Clockwise90 => 1,
            papokin_data::block_rotation::Rotation::Rotate180 => 2,
            papokin_data::block_rotation::Rotation::CounterClockwise90 => 3,
        };
