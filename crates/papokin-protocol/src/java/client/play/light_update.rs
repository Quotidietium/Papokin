...
use papokin_data::packet::clientbound::play::LIGHT_UPDATE;
use papokin_macros::java_packet;
use papokin_util::version::JavaMinecraftVersion;

/// 由服务器发送，用于更新区块的光照等级（方块光和天空光）。
///
/// 此数据包为特定区块更新光照数据，而无需发送完整的区块数据。
/// 它在 Minecraft 1.14（协议版本 477）中引入。
...
impl LightData {
    ...
    pub fn write(
        ...
        // 信任边（1.16 - 1.19.4；1.16 加入，1.20 移除）
