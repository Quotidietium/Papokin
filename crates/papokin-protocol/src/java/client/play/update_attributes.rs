...
use papokin_data::attribute_id_remap::remap_attribute_id_for_version;
use papokin_data::attributes::Attributes;
use papokin_data::packet::clientbound::play::UPDATE_ATTRIBUTES;
...
mod tests {
    ...
    fn assert_armor_attribute_payload(bytes: &[u8], version: JavaMinecraftVersion) {
        ...
        let expected_id = papokin_data::attribute_id_remap::remap_attribute_id_for_version(
