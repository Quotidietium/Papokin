...
mod tests {
    ...
    fn assert_round_trip<T: DataComponentImpl + Clone + 'static>(
        ...
        let restored = read(&value.write_data()).expect("read_data 返回 None");
