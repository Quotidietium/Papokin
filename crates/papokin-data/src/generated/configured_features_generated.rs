...
-> std::collections::HashMap<papokin_data::configured_feature::ConfiguredFeature, ConfiguredFeature>
{
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::Acacia,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    ...
                    BlockStateCodec {
                        name: &papokin_data::Block::ACACIA_LOG,
            ...
            foliage_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    ...
                    BlockStateCodec {
                        name: &papokin_data::Block::ACACIA_LEAVES,
                        properties: Some(props),
                    }
                    .get_state()
                },
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::Birch,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    let mut props = std::collections::HashMap::new();
            ...
            foliage_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    ...
                    props.insert("waterlogged".to_string(), "false".to_string());
                    BlockStateCodec {
                        name: &papokin_data::Block::BIRCH_LEAVES,
                        properties: Some(props),
                    }
                    .get_state()
                },
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::BirchBees005,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    let mut props = std::collections::HashMap::new();
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::Cherry,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    let mut props = std::collections::HashMap::new();
                    props.insert("axis".to_string(), "y".to_string());
                    BlockStateCodec {
                        name: &papokin_data::Block::CHERRY_LOG,
                        properties: Some(props),
                    }
                    .get_state()
                },
            ...
            foliage_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    ...
                    props.insert("waterlogged".to_string(), "false".to_string());
                    BlockStateCodec {
                        name: &papokin_data::Block::CHERRY_LEAVES,
                        properties: Some(props),
                    }
                    .get_state()
                },
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::DarkOak,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    let mut props = std::collections::HashMap::new();
                    props.insert("axis".to_string(), "y".to_string());
                    BlockStateCodec {
                        name: &papokin_data::Block::DARK_OAK_LOG,
                        properties: Some(props),
                    }
                    .get_state()
                },
            ...
            foliage_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    ...
                    props.insert("waterlogged".to_string(), "false".to_string());
                    BlockStateCodec {
                        name: &papokin_data::Block::DARK_OAK_LEAVES,
                        properties: Some(props),
                    }
                    .get_state()
                },
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::FancyOak,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    let mut props = std::collections::HashMap::new();
            ...
            foliage_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    ...
                    props.insert("waterlogged".to_string(), "false".to_string());
                    BlockStateCodec {
                        name: &papokin_data::Block::OAK_LEAVES,
                        properties: Some(props),
                    }
                    .get_state()
                },
        ...
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            ...
            foliage_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    ...
                    props.insert("waterlogged".to_string(), "false".to_string());
                    BlockStateCodec {
                        name: &papokin_data::Block::JUNGLE_LEAVES,
                        properties: Some(props),
                    }
                    .get_state()
                },
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::JungleTreeNoVine,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    let mut props = std::collections::HashMap::new();
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::Mangrove,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    let mut props = std::collections::HashMap::new();
                    props.insert("axis".to_string(), "y".to_string());
                    BlockStateCodec {
                        name: &papokin_data::Block::MANGROVE_LOG,
                        properties: Some(props),
                    }
                    .get_state()
                },
            ...
            trunk_placer: TrunkPlacer {
                ...
                r#type: TrunkType::UpwardsBranching(UpwardsBranchingTrunkPlacer {
                    ...
                    can_grow_through:
                        &papokin_data::tag::Block::MINECRAFT_MANGROVE_LOGS_CAN_GROW_THROUGH.1,
                }),
            },
            foliage_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    ...
                    props.insert("waterlogged".to_string(), "false".to_string());
                    BlockStateCodec {
                        name: &papokin_data::Block::MANGROVE_LEAVES,
                        properties: Some(props),
                    }
                    .get_state()
                },
            ...
            root_placer: Some(RootPlacer::Mangrove(MangroveRootPlacer {
                ...
                root_provider: BlockStateProvider::Simple(SimpleStateProvider {
                    state: {
                        ...
                        props.insert("waterlogged".to_string(), "false".to_string());
                        BlockStateCodec {
                            name: &papokin_data::Block::MANGROVE_ROOTS,
                            properties: Some(props),
                        }
                        .get_state()
                    },
                ...
                above_root_placement: Some(AboveRootPlacement {
                    above_root_provider: BlockStateProvider::Simple(SimpleStateProvider {
                        state: papokin_data::Block::MOSS_CARPET.default_state,
                    }),
                    above_root_placement_chance: 0.5f32,
                }),
                mangrove_root_placement: MangroveRootPlacement {
                    can_grow_through:
                        &papokin_data::tag::Block::MINECRAFT_MANGROVE_ROOTS_CAN_GROW_THROUGH.1,
                    muddy_roots_in: const {
                        &[
                            papokin_data::BlockId::MUD.as_u16(),
                            papokin_data::BlockId::MUDDY_MANGROVE_ROOTS.as_u16(),
                        ]
                    },
                    muddy_roots_provider: BlockStateProvider::Simple(SimpleStateProvider {
                        state: {
                            ...
                            props.insert("axis".to_string(), "y".to_string());
                            BlockStateCodec {
                                name: &papokin_data::Block::MUDDY_MANGROVE_ROOTS,
                                properties: Some(props),
                            }
                            .get_state()
                        },
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::MegaPine,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    let mut props = std::collections::HashMap::new();
            ...
            foliage_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    ...
                    props.insert("waterlogged".to_string(), "false".to_string());
                    BlockStateCodec {
                        name: &papokin_data::Block::SPRUCE_LEAVES,
                        properties: Some(props),
                    }
                    .get_state()
                },
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::Oak,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    let mut props = std::collections::HashMap::new();
        ...
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            ...
            foliage_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    ...
                    props.insert("waterlogged".to_string(), "false".to_string());
                    BlockStateCodec {
                        name: &papokin_data::Block::ORANGE_POPLAR_LEAVES,
                        properties: Some(props),
                    }
                    .get_state()
                },
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::PaleOak,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    let mut props = std::collections::HashMap::new();
                    props.insert("axis".to_string(), "y".to_string());
                    BlockStateCodec {
                        name: &papokin_data::Block::PALE_OAK_LOG,
                        properties: Some(props),
                    }
                    .get_state()
                },
            ...
            foliage_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    ...
                    props.insert("waterlogged".to_string(), "false".to_string());
                    BlockStateCodec {
                        name: &papokin_data::Block::PALE_OAK_LEAVES,
                        properties: Some(props),
                    }
                    .get_state()
                },
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::PaleOakBonemeal,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    let mut props = std::collections::HashMap::new();
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::Pine,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    let mut props = std::collections::HashMap::new();
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::RedPoplar,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    let mut props = std::collections::HashMap::new();
            ...
            foliage_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    ...
                    props.insert("waterlogged".to_string(), "false".to_string());
                    BlockStateCodec {
                        name: &papokin_data::Block::RED_POPLAR_LEAVES,
                        properties: Some(props),
                    }
                    .get_state()
                },
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::Spruce,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    let mut props = std::collections::HashMap::new();
    ...
    map.insert(
        papokin_data::configured_feature::ConfiguredFeature::SwampOak,
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            trunk_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    let mut props = std::collections::HashMap::new();
        ...
        ConfiguredFeature::Tree(Box::new(TreeFeature {
            ...
            foliage_provider: BlockStateProvider::Simple(SimpleStateProvider {
                state: {
                    ...
                    props.insert("waterlogged".to_string(), "false".to_string());
                    BlockStateCodec {
                        name: &papokin_data::Block::YELLOW_POPLAR_LEAVES,
                        properties: Some(props),
                    }
                    .get_state()
                },
