...
use papokin_command::argument_builder::ArgumentBuilder as CoreArgumentBuilder;
pub use papokin_command::node::Redirection;

pub struct CommandArgumentBuilder(
    pub papokin_command::argument_builder::CommandArgumentBuilder<CommandSource>,
);
pub struct LiteralArgumentBuilder(
    pub papokin_command::argument_builder::LiteralArgumentBuilder<CommandSource>,
);
pub struct RequiredArgumentBuilder(
    pub papokin_command::argument_builder::RequiredArgumentBuilder<CommandSource>,
);
...
pub fn command(
    ...
    CommandArgumentBuilder(papokin_command::argument_builder::command(
        literal,
        description,
    ))
}
...
pub fn literal(literal: impl Into<Cow<'static, str>>) -> LiteralArgumentBuilder {
    LiteralArgumentBuilder(papokin_command::argument_builder::literal(literal))
}

pub fn argument(
    name: impl Into<Cow<'static, str>>,
    arg_type: impl papokin_command::argument_types::argument_type::AnyArgumentType<CommandSource>
    + 'static,
) -> RequiredArgumentBuilder {
    RequiredArgumentBuilder(papokin_command::argument_builder::argument(name, arg_type))
}
...
impl ArgumentBuilder for CommandArgumentBuilder {
    type Node = papokin_command::node::detached::CommandDetachedNode<CommandSource>;
...
impl ArgumentBuilder for LiteralArgumentBuilder {
    type Node = papokin_command::node::detached::LiteralDetachedNode<CommandSource>;
...
impl ArgumentBuilder for RequiredArgumentBuilder {
    type Node = papokin_command::node::detached::ArgumentDetachedNode<CommandSource>;
...
impl From<CommandArgumentBuilder>
    for papokin_command::node::detached::CommandDetachedNode<CommandSource>
{
...
impl From<LiteralArgumentBuilder>
    for papokin_command::node::detached::LiteralDetachedNode<CommandSource>
{
    fn from(b: LiteralArgumentBuilder) -> Self {
        b.0.build()
    }
...
impl From<RequiredArgumentBuilder>
    for papokin_command::node::detached::ArgumentDetachedNode<CommandSource>
{
    fn from(b: RequiredArgumentBuilder) -> Self {
        b.0.build()
    }
