...
use papokin_protocol::java::client::play::{CRecipeBookAdd, CRecipeBookRemove};
...
fn get_recipe_id(recipe: &DynamicRecipe) -> String {
    match recipe {
        ...
        DynamicRecipe::Cooking(cooking) => match cooking {
            papokin_protocol::codec::recipe::OwnedCookingRecipeType::Smelting(r)
            | papokin_protocol::codec::recipe::OwnedCookingRecipeType::Blasting(r)
            | papokin_protocol::codec::recipe::OwnedCookingRecipeType::Smoking(r)
            | papokin_protocol::codec::recipe::OwnedCookingRecipeType::CampfireCooking(r) => {
                r.recipe_id.clone()
            }
        },
        ...
        DynamicRecipe::Smithing(smithing) => match smithing {
            papokin_protocol::codec::recipe::OwnedSmithingRecipe::Transform {
                recipe_id, ..
            }
            | papokin_protocol::codec::recipe::OwnedSmithingRecipe::Trim { recipe_id, .. } => {
                recipe_id.clone()
            }
        },
    }
