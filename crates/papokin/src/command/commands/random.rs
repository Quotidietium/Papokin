...
const RANGE_TOO_LARGE_ERROR_TYPE: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_RANDOM_ERROR_RANGE_TOO_LARGE);

const RANGE_TOO_SMALL_ERROR_TYPE: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_RANDOM_ERROR_RANGE_TOO_SMALL);
