...
use papokin_data::translation::java::{COMMANDS_LIST_NAMEANDID, COMMANDS_LIST_PLAYERS};
use papokin_util::{
...
impl CommandExecutor for ListCommandExecutor {
    fn execute(&self, context: &CommandContext) -> CommandExecutorResult {
        ...
        let max_players = context.server().advanced_config.networking.java.max_players;
