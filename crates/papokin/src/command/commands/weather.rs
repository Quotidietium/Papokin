        ...
        let (message, return_val) = {
            ...
            match self.mode {
                WeatherMode::Clear => {
                    ...
                    (
                        TextComponent::translate(translation::java::COMMANDS_WEATHER_SET_CLEAR, []),
                ...
                WeatherMode::Rain => {
                    ...
                    (
                        TextComponent::translate(translation::java::COMMANDS_WEATHER_SET_RAIN, []),
                        duration.unwrap_or(-1),
                    )
                }
                WeatherMode::Thunder => {
