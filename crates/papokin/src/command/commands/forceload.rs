...
const DESCRIPTION: &str = "在世界中持续加载区块。";
const PERMISSION: &str = "minecraft:command.forceload";

static ERROR_FAILED_ADD: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_FORCELOAD_ADDED_FAILURE);
static ERROR_FAILED_REMOVE: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_FORCELOAD_REMOVED_FAILURE);
static ERROR_FAILED_QUERY: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_FORCELOAD_QUERY_FAILURE);
static ERROR_TOO_MANY: CommandErrorType<2> =
    CommandErrorType::new(translation::java::COMMANDS_FORCELOAD_TOOBIG);
