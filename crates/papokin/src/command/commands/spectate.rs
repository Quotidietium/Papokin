...
use papokin_protocol::java::client::play::CSetCamera;
use papokin_util::permission::{Permission, PermissionDefault, PermissionRegistry};
use papokin_util::text::TextComponent;
use papokin_util::{GameMode, PermissionLvl};
...
const DESCRIPTION: &str = "允许旁观模式玩家观察指定目标实体。";
...
const ERROR_NOT_SPECTATOR: CommandErrorType<1> =
    CommandErrorType::new(translation::java::COMMANDS_SPECTATE_NOT_SPECTATOR);

const ERROR_SELF: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_SPECTATE_SELF);

const ERROR_CANNOT_SPECTATE: CommandErrorType<1> =
    CommandErrorType::new(translation::java::COMMANDS_SPECTATE_CANNOT_SPECTATE);
...
impl CommandExecutor for StopSpectateExecutor {
    fn execute(&self, context: &CommandContext) -> CommandExecutorResult {
        ...
        context.source.send_feedback(
            TextComponent::translate(translation::java::COMMANDS_SPECTATE_SUCCESS_STOPPED, []),
            false,
        );
