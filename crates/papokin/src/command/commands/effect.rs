...
const DESCRIPTION: &str = "添加或移除玩家和其他实体的状态效果。";
...
const ERROR_GIVE_FAILED: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_EFFECT_GIVE_FAILED);

const ERROR_CLEAR_EVERYTHING_FAILED: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_EFFECT_CLEAR_EVERYTHING_FAILED);

const ERROR_CLEAR_SPECIFIC_FAILED: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_EFFECT_CLEAR_SPECIFIC_FAILED);
