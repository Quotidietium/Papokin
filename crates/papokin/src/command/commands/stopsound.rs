...
const DESCRIPTION: &str = "停止正在播放的声音。";
...
impl CommandExecutor for StopSoundExecutor {
    fn execute(&self, context: &CommandContext) -> CommandExecutorResult {
        ...
        let text = match (category, &sound) {
            (Some(c), Some(s)) => TextComponent::translate(
