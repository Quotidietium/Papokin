...
const DESCRIPTION: &str = "在指定位置播放声音。";
const PERMISSION: &str = "minecraft:command.playsound";

const ERROR_TOO_FAR: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_PLAYSOUND_FAILED);
...
fn play_sound(
    ...
    let sound_event = Sound::from_name(sound.path())
        ...
        .map_or_else(
            || {
                IdOr::Value(papokin_protocol::SoundEvent {
