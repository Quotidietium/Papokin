...
use papokin_protocol::java::client::play::{CWaypoint, WaypointIcon};
...
const DESCRIPTION: &str = "列出或修改路径点。";
...
impl CommandExecutor for StyleExecutor {
    fn execute(&self, context: &CommandContext) -> CommandExecutorResult {
        ...
        context.source.send_feedback(
            papokin_macros::translate!(translation::java::COMMANDS_WAYPOINT_MODIFY_STYLE),
            true,
        );
