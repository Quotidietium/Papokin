...
const DESCRIPTION: &str = "查询或修改实体的属性。";
...
const FAILED_ENTITY_ERROR: CommandErrorType<1> =
    CommandErrorType::new(translation::java::COMMANDS_ATTRIBUTE_FAILED_ENTITY);

const NO_ATTRIBUTE_ERROR: CommandErrorType<2> =
    CommandErrorType::new(translation::java::COMMANDS_ATTRIBUTE_FAILED_NO_ATTRIBUTE);

const MODIFIER_ALREADY_PRESENT_ERROR: CommandErrorType<3> =
    CommandErrorType::new(translation::java::COMMANDS_ATTRIBUTE_FAILED_MODIFIER_ALREADY_PRESENT);

const NO_MODIFIER_ERROR: CommandErrorType<3> =
    CommandErrorType::new(translation::java::COMMANDS_ATTRIBUTE_FAILED_NO_MODIFIER);
