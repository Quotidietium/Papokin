...
const DESCRIPTION: &str = "修改一个触发器记分板目标。";
const PERMISSION: &str = "minecraft:command.trigger";

const ARG_OBJECTIVE: &str = "objective";
const ARG_VALUE: &str = "value";

const INVALID_TRIGGER_ERROR: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_TRIGGER_FAILED_INVALID);

const UNPRIMED_TRIGGER_ERROR: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_TRIGGER_FAILED_UNPRIMED);
