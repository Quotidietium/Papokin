...
const DESCRIPTION: &str = "封禁一个玩家 IP。";
const PERMISSION: &str = "minecraft:command.banip";

const ERROR_BANIP_INVALID: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_BANIP_INVALID);

const ERROR_BANIP_FAILED: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_BANIP_FAILED);
