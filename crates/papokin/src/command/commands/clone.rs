...
use papokin_data::{Block, BlockStateId, translation};
...
const DESCRIPTION: &str = "将方块从一个区域克隆到另一个区域。";
...
const OVERLAP_ERROR: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_CLONE_OVERLAP);

const TOOBIG_ERROR: CommandErrorType<2> =
    CommandErrorType::new(translation::java::COMMANDS_CLONE_TOOBIG);

const FAILED_ERROR: CommandErrorType<0> =
    CommandErrorType::new(translation::java::COMMANDS_CLONE_FAILED);

const NOT_LOADED_ERROR: CommandErrorType<0> =
    CommandErrorType::new(translation::java::ARGUMENT_POS_UNLOADED);

const OUT_OF_WORLD_ERROR: CommandErrorType<0> =
            ...
            for y in 0..size_y {
                for z in 0..size_z {
                    ...
                    let should_clone = match self.mask_mode {
                        ...
                        MaskMode::Masked => !papokin_data::block_properties::is_air(state_id),
                        MaskMode::Filtered => {
