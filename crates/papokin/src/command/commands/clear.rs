...
const DESCRIPTION: &str = "清空你自己或目标（多个）的物品栏。";
const PERMISSION: &str = "minecraft:command.clear";

const ERROR_SINGLE: CommandErrorType<1> =
    CommandErrorType::new(translation::java::CLEAR_FAILED_SINGLE);

const ERROR_MULTIPLE: CommandErrorType<1> =
    CommandErrorType::new(translation::java::CLEAR_FAILED_MULTIPLE);
