...
const DESCRIPTION: &str = "创建、查询、重启和移除全局秒表。";
const PERMISSION: &str = "minecraft:command.stopwatch";

pub const ERROR_ALREADY_EXISTS: CommandErrorType<1> =
    CommandErrorType::new(translation::java::COMMANDS_STOPWATCH_ALREADY_EXISTS);

pub const ERROR_DOES_NOT_EXIST: CommandErrorType<1> =
    CommandErrorType::new(translation::java::COMMANDS_STOPWATCH_DOES_NOT_EXIST);
