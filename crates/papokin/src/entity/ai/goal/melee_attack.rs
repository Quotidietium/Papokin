...
impl Goal for MeleeAttackGoal {
    fn can_start(&mut self, mob: &dyn Mob) -> bool {
        ...
        // TODO: Navigation 实现后添加路径
        true //TODO: 修改此处逻辑：如果通往目标的路径不存在，则调用 mob.is_in_attack_range(target)
    }
    ...
    fn stop(&mut self, mob: &dyn Mob) {
        ...
        // 原版：this.mob.getNavigation().stop()
        mob.get_mob_entity()
            .navigator
            .lock()
            .unwrap_or_else(std::sync::PoisonError::into_inner)
