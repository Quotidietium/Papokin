...
impl InteractionEntity {
    ...
    pub fn set_width(&self, width: f32) {
        *self
        ...
        self.entity
            .set_synced_data(papokin_data::tracked_data::interaction::WIDTH, width);
    }
    ...
    pub fn set_height(&self, height: f32) {
        *self
        ...
        self.update_dimensions();
        self.entity
            .set_synced_data(papokin_data::tracked_data::interaction::HEIGHT, height);
    }
    ...
    pub fn set_response(&self, response: bool) {
        ...
        self.entity
            .set_synced_data(papokin_data::tracked_data::interaction::RESPONSE, response);
    }
