...
use papokin_util::math::{vector2::Vector2, vector3::Vector3};
...
impl super::Phase for DyingPhase {
    ...
    fn tick(&self, dragon: &EnderDragonEntity) {
        ...
        // 2. 朝目标平台转向并更新生命值，与原版 doServerTick 一致
        ...
        // 4. 与 doClientTick 一致的爆炸粒子（每 10 刻及最后几刻）
