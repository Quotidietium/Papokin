...
use papokin_protocol::java::client::play::{CEntityVelocity, CSoundEffect, Metadata};
...
impl ArrowEntity {
    ...
    fn write_item_stack_nbt(item_stack: &ItemStack, nbt: &mut papokin_nbt::compound::NbtCompound) {
        let mut item = papokin_nbt::compound::NbtCompound::new();
        item_stack.copy_with_count(1).write_item_stack(&mut item);
        nbt.put_compound("item", item);
    }

    fn read_item_stack_nbt(nbt: &papokin_nbt::compound::NbtCompound) -> Option<ItemStack> {
    ...
    const fn spectral_glowing_effect() -> papokin_data::potion::Effect {
        papokin_data::potion::Effect {
            effect_type: &papokin_data::effect::StatusEffect::GLOWING,
            duration: 200,
            amplifier: 0,
            ambient: false,
            show_particles: true,
    ...
    pub fn get_effect_color(item_stack: &ItemStack) -> i32 {
        if let Some(pc) =
            item_stack.get_data_component::<papokin_data::data_component_impl::PotionContentsImpl>()
        {
    ...
    pub fn set_critical(&self, critical: bool) {
        ...
        self.entity
            .set_synced_data(papokin_data::tracked_data::abstract_arrow::ID_FLAGS, flags);
    }
    ...
    pub fn set_pierce_level(&self, level: u8) {
        ...
        self.entity.set_synced_data(
            papokin_data::tracked_data::abstract_arrow::PIERCE_LEVEL,
            level,
        );
    }
...
impl EntityBase for ArrowEntity {
    ...
    fn write_custom_nbt(&self, nbt: &mut papokin_nbt::compound::NbtCompound) {
        let item_stack = self
            .item_stack
            .read()
    ...
    fn read_custom_nbt(&self, nbt: &papokin_nbt::compound::NbtCompound) {
    ...
    fn init_data_tracker(&self) {
        ...
        if entity.entity_type.id == EntityType::SPECTRAL_ARROW.id {
            entity.set_synced_data(papokin_data::tracked_data::spectral_arrow::ID_FLAGS, flags);
            entity.set_synced_data(
                papokin_data::tracked_data::spectral_arrow::PIERCE_LEVEL,
                pierce,
            );
            entity.set_synced_data(
                papokin_data::tracked_data::spectral_arrow::IN_GROUND,
                in_ground,
            );
        } else {
            let item_stack = self
            ...
            entity.set_synced_data(papokin_data::tracked_data::arrow::ID_FLAGS, flags);
            entity.set_synced_data(papokin_data::tracked_data::arrow::PIERCE_LEVEL, pierce);
            entity.set_synced_data(papokin_data::tracked_data::arrow::IN_GROUND, in_ground);
            entity.set_synced_data(papokin_data::tracked_data::arrow::ID_EFFECT_COLOR, color);
        }
    ...
    fn java_spawn_metadata(&self, version: JavaMinecraftVersion) -> Option<Box<[u8]>> {
        ...
        if entity.entity_type.id == EntityType::SPECTRAL_ARROW.id {
            let _ = Metadata::new(papokin_data::tracked_data::spectral_arrow::ID_FLAGS, flags)
                .write(&mut buf, &version);
            let _ = Metadata::new(
                papokin_data::tracked_data::spectral_arrow::PIERCE_LEVEL,
                pierce,
            ...
            let item_stack = self
                ...
                .unwrap_or_else(std::sync::PoisonError::into_inner);
            let color = Self::get_effect_color(&item_stack);
            let _ = Metadata::new(papokin_data::tracked_data::arrow::ID_FLAGS, flags)
                .write(&mut buf, &version);
            let _ = Metadata::new(papokin_data::tracked_data::arrow::PIERCE_LEVEL, pierce)
                .write(&mut buf, &version);
            let _ = Metadata::new(papokin_data::tracked_data::arrow::IN_GROUND, in_ground)
                .write(&mut buf, &version);
            if color != -1 {
                let _ = Metadata::new(papokin_data::tracked_data::arrow::ID_EFFECT_COLOR, color)
                    .write(&mut buf, &version);
            }
        }
        (!buf.is_empty()).then(|| {
    ...
    fn tick(&self, caller: &dyn EntityBase, _server: &Server) {
        ...
        if current_block == &papokin_data::Block::LAVA
            || current_block == &papokin_data::Block::FIRE
            || current_block == &papokin_data::Block::SOUL_FIRE
        {
            let duration = if current_block == &papokin_data::Block::LAVA {
                15.0
            } else {
                8.0
            };
        ...
        if self.in_ground.load(Ordering::Relaxed) {
            ...
            if let Some(pos) = last_pos {
                ...
                if block.is_air() {
                    ...
                    entity.set_synced_data(
                        papokin_data::tracked_data::abstract_arrow::IN_GROUND,
                        false,
                    );
        ...
        match hit {
            ProjectileHit::Block {
                ...
                *self
                ...
                if block == &papokin_data::Block::TARGET
                ...
                // 通知客户端箭已插入地面
                entity.set_synced_data(papokin_data::tracked_data::abstract_arrow::IN_GROUND, true);
            ...
            ProjectileHit::Entity {
                ...
                let is_enderman =
                    target.get_entity().entity_type == &papokin_data::entity::EntityType::ENDERMAN;
                let is_on_fire = entity.is_on_fire() || self.is_flame.load(Ordering::Relaxed);
...
impl ArrowEntity {
    fn should_skip_collision(&self, self_ent: &Entity, other: &Arc<dyn EntityBase>) -> bool {
        ...
        // 跳过其他箭、物品实体、下落方块实体和区域效果云
        if (other_ent.entity_type == &papokin_data::entity::EntityType::ARROW
            || other_ent.entity_type == &papokin_data::entity::EntityType::SPECTRAL_ARROW)
            ...
            || other_ent.entity_type == &papokin_data::entity::EntityType::AREA_EFFECT_CLOUD
        {
            return true;
        }
...
mod tests {
    ...
    fn arrow_nbt_payload_round_trips() {
        ...
        let restored = ArrowEntity::read_item_stack_nbt(&nbt).expect("箭矢载荷应能解码");
