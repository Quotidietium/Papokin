...
impl EntityBase for EggEntity {
    ...
    fn init_data_tracker(&self) {
        ...
        // 同步物品堆，使客户端渲染出正确的颜色/变体
        entity.set_synced_data(
            papokin_data::tracked_data::egg::ITEM_STACK,
    ...
    fn on_hit(&self, hit: crate::entity::projectile::ProjectileHit) {
        ...
        let variant_name = {
            let stack = self
                ...
                .unwrap_or_else(std::sync::PoisonError::into_inner);
            stack
                .get_data_component::<papokin_data::data_component_impl::ChickenVariantImpl>()
