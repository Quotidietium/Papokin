...
use papokin_data::{damage::DamageType, effect::StatusEffect, potion::Effect, tracked_data};
use papokin_nbt::compound::NbtCompound;
use papokin_util::{Difficulty, math::vector3::Vector3};
        ...
        if let ProjectileHit::Entity { ref entity, .. } = hit {
            ...
            if let Some(living) = entity.get_living_entity() {
                let duration = match difficulty {
                    Difficulty::Hard => 800,   // 40 秒
                    Difficulty::Normal => 200, // 10 秒
