...
impl FoxEntity {
    ...
    pub fn set_variant(&self, variant: FoxVariant) {
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::fox::TYPE_ID,
            VarInt(variant.id()),
        );
    }
    ...
    fn set_flag(&self, flag: u8, value: bool) {
        ...
        let entity = self.get_entity();
        entity.set_synced_data(papokin_data::tracked_data::fox::FLAGS_ID, new_flags);
    }
...
impl Mob for FoxEntity {
    ...
    fn mob_init_data_tracker(&self) {
        ...
        if is_baby {
            entity.set_synced_data(papokin_data::tracked_data::fox::BABY_ID, true);
        }
        entity.set_synced_data(
            papokin_data::tracked_data::fox::TYPE_ID,
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::fox::FLAGS_ID,
