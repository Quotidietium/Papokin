...
impl HappyGhastEntity {
    ...
    fn set_leash_holder(&self, is_leash_holder: bool) {
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::happy_ghast::IS_LEASH_HOLDER,
            is_leash_holder,
        );
    }
    ...
    fn sync_stay_still_flag(&self) {
        ...
        let entity = self.get_entity();
        entity.set_synced_data(
            papokin_data::tracked_data::happy_ghast::STAYS_STILL,
            stays_still,
        );
    }
}
...
impl Mob for HappyGhastEntity {
    ...
    fn mob_init_data_tracker(&self) {
        ...
        if is_baby {
            entity.set_synced_data(papokin_data::tracked_data::happy_ghast::BABY_ID, true);
        }
        entity.set_synced_data(
            papokin_data::tracked_data::happy_ghast::IS_LEASH_HOLDER,
