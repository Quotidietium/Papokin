...
impl CamelEntity {
    ...
    pub fn set_flag(&self, flag: u8, val: bool) {
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::camel::DATA_ID_FLAGS,
            new_flags as i8,
        );
    }
    ...
    pub fn set_dashing(&self, dashing: bool) {
        ...
        let entity = self.get_entity();
        entity.set_synced_data(papokin_data::tracked_data::camel::DASH, dashing);
    }
}
...
impl Mob for CamelEntity {
    ...
    fn mob_init_data_tracker(&self) {
        ...
        if is_baby {
            entity.set_synced_data(papokin_data::tracked_data::camel::DATA_BABY_ID, true);
        }
        entity.set_synced_data(
            papokin_data::tracked_data::camel::DATA_ID_FLAGS,
            self.flags.load(Ordering::Relaxed) as i8,
        );
        entity.set_synced_data(papokin_data::tracked_data::camel::DASH, self.is_dashing());
    }
