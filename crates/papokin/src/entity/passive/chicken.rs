...
impl ChickenEntity {
    pub fn new(entity: Entity) -> Arc<Self> {
        ...
        let chicken = Self {
            mob_entity,
            variant: AtomicU8::new(1), // 默认为 temperate
...
impl Animal for ChickenEntity {
    fn is_food(&self, item_stack: &ItemStack) -> bool {
        ...
        item_stack
            .item
            .has_tag(&papokin_data::tag::Item::MINECRAFT_CHICKEN_FOOD)
...
impl Mob for ChickenEntity {
    ...
    fn mob_init_data_tracker(&self) {
        ...
        if is_baby {
            entity.set_synced_data(papokin_data::tracked_data::chicken::BABY_ID, true);
        }
        entity.set_synced_data(
            papokin_data::tracked_data::chicken::VARIANT,
