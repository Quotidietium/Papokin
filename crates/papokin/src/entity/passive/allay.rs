...
impl AllayEntity {
    ...
    pub fn set_dancing(&self, dancing: bool) {
        ...
        entity.set_synced_data(papokin_data::tracked_data::allay::DATA_DANCING, dancing);
    }
    ...
    pub fn set_can_duplicate(&self, can_duplicate: bool) {
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::allay::DATA_CAN_DUPLICATE,
            can_duplicate,
        );
    }
}
...
impl Mob for AllayEntity {
    ...
    fn mob_init_data_tracker(&self) {
        let entity = self.get_entity();
        entity.set_synced_data(
            papokin_data::tracked_data::allay::DATA_DANCING,
            self.is_dancing(),
        );
        entity.set_synced_data(
            papokin_data::tracked_data::allay::DATA_CAN_DUPLICATE,
