...
impl SnifferEntity {
    ...
    pub fn set_state(&self, state: SnifferState) {
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::sniffer::STATE,
            VarInt(state.id()),
        );
    }
    ...
    fn on_digging_start(&self) {
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::sniffer::DROP_SEED_AT_TICK,
            VarInt(drop_tick),
        );
        world.send_entity_status(entity, EntityStatus::SnifferDiggingSound);
    }
    ...
    fn can_dig_at(&self, pos: BlockPos) -> bool {
        ...
        let block = papokin_data::Block::from_state_id(block_state.id);
...
impl Mob for SnifferEntity {
    ...
    fn mob_init_data_tracker(&self) {
        ...
        if is_baby {
            entity.set_synced_data(papokin_data::tracked_data::sniffer::BABY_ID, true);
        }
        entity.set_synced_data(
            papokin_data::tracked_data::sniffer::STATE,
