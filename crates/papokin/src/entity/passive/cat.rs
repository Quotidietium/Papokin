...
impl CatEntity {
    pub fn new(entity: Entity) -> Arc<Self> {
        ...
        let cat = Self {
            mob_entity,
            variant: AtomicU8::new(1),       // 默认为黑色
            sound_variant: AtomicU8::new(0), // 默认为 classic
            collar_color: AtomicU8::new(14), // 默认为红色
...

        {
            ...
            // 目标 1：SwimGoal（FloatGoal）
            goal_selector.add_goal(1, Box::new(SwimGoal::default()));
            // 目标 1：TamableAnimalPanicGoal（EscapeDangerGoal）
            goal_selector.add_goal(1, EscapeDangerGoal::new(1.5));
            // 目标 4：CatTemptGoal
            goal_selector.add_goal(4, Box::new(TemptGoal::new(0.6, TEMPT_ITEMS, true)));
            // 目标 4：CatAvoidEntityGoal（未驯服时）
...

        {
            ...
            // 目标 Goal 1：兔子和海龟的 NonTameRandomTargetGoal
    ...
    pub fn set_collar_color(&self, color: u8) {
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::cat::CAT_COLLAR_COLOR,
            VarInt(color as i32),
        );
    }
    ...
    pub fn set_sitting(&self, sitting: bool) {
        ...
        let entity = self.get_entity();
        entity.set_synced_data(
            papokin_data::tracked_data::cat::TAMEABLE_FLAGS,
            self.get_tame_flags(),
        );
    }
    ...
    pub fn set_tame(&self, tame: bool, owner: Option<Uuid>) {
        ...
        entity.set_synced_data(papokin_data::tracked_data::cat::OWNER_UUID, owner);
    }
    ...
    pub fn set_variant(&self, variant: u8) {
        ...
        let entity = self.get_entity();
        entity.set_synced_data(
            papokin_data::tracked_data::cat::CAT_VARIANT,
    ...
    pub fn set_lying(&self, lying: bool) {
        ...
        let entity = self.get_entity();
        entity.set_synced_data(papokin_data::tracked_data::cat::IS_LYING, lying);
    }

    pub fn set_relax_state_one(&self, relax: bool) {
        self.relax_state_one.store(relax, Ordering::Relaxed);
        let entity = self.get_entity();
        entity.set_synced_data(papokin_data::tracked_data::cat::RELAX_STATE_ONE, relax);
    }
    ...
    pub fn play_eating_sound(&self) {
        ...
        world.play_sound(
            papokin_data::sound::Sound::EntityCatEat,
...
impl Mob for CatEntity {
    ...
    fn mob_init_data_tracker(&self) {
        ...
        if is_baby {
            entity.set_synced_data(papokin_data::tracked_data::cat::BABY_ID, true);
        }
        entity.set_synced_data(
            papokin_data::tracked_data::cat::TAMEABLE_FLAGS,
            self.get_tame_flags(),
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::cat::OWNER_UUID,
            self.get_owner(),
        );
        entity.set_synced_data(
            papokin_data::tracked_data::cat::CAT_VARIANT,
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::cat::IS_LYING,
            self.is_lying.load(Ordering::Relaxed),
        );
        entity.set_synced_data(
            papokin_data::tracked_data::cat::RELAX_STATE_ONE,
            self.relax_state_one.load(Ordering::Relaxed),
        );
        entity.set_synced_data(
            papokin_data::tracked_data::cat::CAT_COLLAR_COLOR,
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::cat::SOUND_VARIANT,
        ...
        if self.is_tame() {
            ...
            if rng.random_range(0..3) == 0 {
                ...
                self.get_entity()
                    .world
                    .load()
                    .send_entity_status(self.get_entity(), EntityStatus::TamingSucceeded);
            } else {
                self.get_entity()
                    .world
                    .load()
                    .send_entity_status(self.get_entity(), EntityStatus::TamingFailed);
            }
