...
impl GoatEntity {
    ...
    pub fn set_screaming(&self, screaming: bool) {
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::goat::DATA_IS_SCREAMING_GOAT,
            screaming,
        );
    }
    ...
    pub fn set_has_left_horn(&self, has_horn: bool) {
        ...
        let entity = self.get_entity();
        entity.set_synced_data(
            papokin_data::tracked_data::goat::DATA_HAS_LEFT_HORN,
            has_horn,
        );
    }
    ...
    pub fn set_has_right_horn(&self, has_horn: bool) {
        ...
        let entity = self.get_entity();
        entity.set_synced_data(
            papokin_data::tracked_data::goat::DATA_HAS_RIGHT_HORN,
            has_horn,
        );
    }
}
...
impl Mob for GoatEntity {
    ...
    fn mob_init_data_tracker(&self) {
        ...
        if is_baby {
            entity.set_synced_data(papokin_data::tracked_data::goat::DATA_BABY_ID, true);
        }
        entity.set_synced_data(
            papokin_data::tracked_data::goat::DATA_IS_SCREAMING_GOAT,
            self.is_screaming(),
