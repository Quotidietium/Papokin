...
impl PandaEntity {
    ...
    pub fn set_main_gene(&self, gene: PandaGene) {
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::panda::MAIN_GENE_ID,
            gene.id() as i8,
        );
    }
    ...
    pub fn set_hidden_gene(&self, gene: PandaGene) {
        ...
        let entity = self.get_entity();
        entity.set_synced_data(
            papokin_data::tracked_data::panda::HIDDEN_GENE_ID,
            gene.id() as i8,
        );
    }
    ...
    pub fn set_flag(&self, flag: u8, val: bool) {
        ...
        let entity = self.get_entity();
        entity.set_synced_data(
            papokin_data::tracked_data::panda::DATA_ID_FLAGS,
            new_flags as i8,
        );
    }
...
impl Mob for PandaEntity {
    ...
    fn mob_init_data_tracker(&self) {
        ...
        if is_baby {
            entity.set_synced_data(papokin_data::tracked_data::panda::DATA_BABY_ID, true);
        }
        entity.set_synced_data(
            papokin_data::tracked_data::panda::MAIN_GENE_ID,
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::panda::UNHAPPY_COUNTER,
            VarInt(self.unhappy_counter.load(Ordering::Relaxed)),
        );
        entity.set_synced_data(
            papokin_data::tracked_data::panda::SNEEZE_COUNTER,
            VarInt(self.sneeze_counter.load(Ordering::Relaxed)),
        );
        entity.set_synced_data(
            papokin_data::tracked_data::panda::EAT_COUNTER,
