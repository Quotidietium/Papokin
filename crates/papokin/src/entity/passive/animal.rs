...
pub trait Animal: Mob {
    ...
    /// 动物偏好草方块，其次是明亮的地方。
    fn animal_walk_target_value(&self, pos: &papokin_util::math::position::BlockPos) -> f32 {
        let world = self.get_mob_entity().living_entity.entity.world.load();
        if world.get_block(&pos.down()).id == papokin_data::Block::GRASS_BLOCK.id {
            return 10.0;
        }
    ...
    fn write_animal_nbt(&self, nbt: &mut papokin_nbt::compound::NbtCompound) {
        let mob_entity = self.get_mob_entity();
    ...
    fn read_animal_nbt(&self, nbt: &papokin_nbt::compound::NbtCompound) {
        let mob_entity = self.get_mob_entity();
    ...
    fn animal_interact(
        ...
        if self.is_food(item_stack) {
            ...
            if age >= 0 && mob_entity.is_breeding_ready() && !mob_entity.is_in_love() {
                ...
                world.send_entity_status(entity, papokin_data::entity::EntityStatus::InLoveHearts);
...
#[must_use]
pub fn get_dye_color_from_item(item: &papokin_data::item::Item) -> Option<u8> {
...
#[must_use]
pub const fn get_wool_item_for_color(color: u8) -> &'static papokin_data::item::Item {
    match color {
        0 => &papokin_data::item::Item::WHITE_WOOL,
        1 => &papokin_data::item::Item::ORANGE_WOOL,
        2 => &papokin_data::item::Item::MAGENTA_WOOL,
        3 => &papokin_data::item::Item::LIGHT_BLUE_WOOL,
        4 => &papokin_data::item::Item::YELLOW_WOOL,
        5 => &papokin_data::item::Item::LIME_WOOL,
        6 => &papokin_data::item::Item::PINK_WOOL,
        7 => &papokin_data::item::Item::GRAY_WOOL,
        8 => &papokin_data::item::Item::LIGHT_GRAY_WOOL,
        9 => &papokin_data::item::Item::CYAN_WOOL,
        10 => &papokin_data::item::Item::PURPLE_WOOL,
        11 => &papokin_data::item::Item::BLUE_WOOL,
        12 => &papokin_data::item::Item::BROWN_WOOL,
        13 => &papokin_data::item::Item::GREEN_WOOL,
        14 => &papokin_data::item::Item::RED_WOOL,
        _ => &papokin_data::item::Item::BLACK_WOOL,
    }
}

#[must_use]
pub fn get_carpet_color_from_item(item: &papokin_data::item::Item) -> Option<u8> {
    match item.registry_key {
        "white_carpet" => Some(0),
