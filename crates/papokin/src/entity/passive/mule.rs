...
impl MuleEntity {
    ...
    pub fn set_flag(&self, flag: u8, val: bool) {
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::mule::DATA_ID_FLAGS,
            new_flags as i8,
        );
    }
    ...
    pub fn set_has_chest(&self, val: bool) {
        ...
        let entity = self.get_entity();
        entity.set_synced_data(papokin_data::tracked_data::mule::DATA_ID_CHEST, val);
    }
}
...
impl Mob for MuleEntity {
    ...
    fn mob_init_data_tracker(&self) {
        ...
        if is_baby {
            entity.set_synced_data(papokin_data::tracked_data::mule::DATA_BABY_ID, true);
        }
        entity.set_synced_data(
            papokin_data::tracked_data::mule::DATA_ID_CHEST,
            self.has_chest(),
        );
        entity.set_synced_data(
            papokin_data::tracked_data::mule::DATA_ID_FLAGS,
