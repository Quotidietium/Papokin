...
impl AxolotlEntity {
    ...
    pub fn set_variant(&self, variant: AxolotlVariant) {
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::axolotl::DATA_VARIANT,
            VarInt(variant.id()),
        );
    }
    ...
    pub fn set_playing_dead(&self, playing_dead: bool) {
        ...
        let entity = self.get_entity();
        entity.set_synced_data(
            papokin_data::tracked_data::axolotl::DATA_PLAYING_DEAD,
            playing_dead,
        );
    }
    ...
    pub fn set_from_bucket(&self, from_bucket: bool) {
        ...
        let entity = self.get_entity();
        entity.set_synced_data(
            papokin_data::tracked_data::axolotl::FROM_BUCKET,
            from_bucket,
        );
    }
}
...
impl Mob for AxolotlEntity {
    ...
    fn mob_init_data_tracker(&self) {
        ...
        if is_baby {
            entity.set_synced_data(papokin_data::tracked_data::axolotl::DATA_BABY_ID, true);
        }
        entity.set_synced_data(
            papokin_data::tracked_data::axolotl::DATA_VARIANT,
