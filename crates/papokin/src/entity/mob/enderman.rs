...
use papokin_data::{BlockStateId, attributes::Attributes};
...
fn is_projectile_damage(dt: DamageType) -> bool {
    let (names, _) = papokin_data::tag::DamageType::MINECRAFT_IS_PROJECTILE;
...
impl EndermanEntity {
    ...
    pub fn set_angry(&self, angry: bool) {
        ...
        self.mob_entity
            .living_entity
            .entity
            .set_synced_data(papokin_data::tracked_data::enderman::CREEPY, angry);
    }
    ...
    pub fn set_provoked(&self, provoked: bool) {
        ...
        self.mob_entity
            .living_entity
            .entity
            .set_synced_data(papokin_data::tracked_data::enderman::STARED_AT, provoked);
    }
    ...
    pub fn set_carried_block(&self, block_state: Option<BlockStateId>) {
        ...
        self.mob_entity
            .living_entity
            .entity
            .set_synced_data(papokin_data::tracked_data::enderman::CARRY_STATE, value);
    }
...
impl Mob for EndermanEntity {
    ...
    // TODO: 躲避阳光、死亡时掉落携带的方块、可激怒系统、环境音效覆盖
