...
use papokin_protocol::java::client::play::CEntityPositionSync;
...
impl ShulkerEntity {
    ...
    pub fn set_attach_face(&self, face: BlockDirection) {
        ...
        entity.set_synced_data(
            papokin_data::tracked_data::shulker::ATTACH_FACE_ID,
            VarInt(face as i32),
        );
    }
    ...
    pub fn set_color(&self, color: Option<u8>) {
        ...
        let entity = &self.mob_entity.living_entity.entity;
        entity.set_synced_data(papokin_data::tracked_data::shulker::COLOR, val as i8);
    }
    ...
    pub fn set_raw_peek(&self, amount: u8) {
        ...
        entity.set_synced_data(papokin_data::tracked_data::shulker::PEEK_ID, amount);
    }
