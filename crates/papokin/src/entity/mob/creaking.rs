...
use papokin_protocol::java::client::play::CEntityStatus;
...
impl CreakingEntity {
    ...
    pub fn set_can_move(&self, can_move: bool) {
        ...
        self.mob_entity
            .living_entity
            .entity
            .set_synced_data(papokin_data::tracked_data::creaking::CAN_MOVE, can_move);
    }
    ...
    pub fn set_is_active(&self, active: bool) {
        ...
        self.mob_entity
            .living_entity
            .entity
            .set_synced_data(papokin_data::tracked_data::creaking::IS_ACTIVE, active);
    }
    ...
    pub fn set_tearing_down(&self) {
        ...
        self.mob_entity
            .living_entity
            .entity
            .set_synced_data(papokin_data::tracked_data::creaking::IS_TEARING_DOWN, true);
    }
    ...
    pub fn set_home_pos(&self, pos: Option<BlockPos>) {
        ...
        self.mob_entity
            .living_entity
            .entity
            .set_synced_data(papokin_data::tracked_data::creaking::HOME_POS, pos);
    }
    ...
    pub fn check_can_move(&self) -> bool {
        ...
        for player in players {
            if player.living_entity.entity.is_alive()
                && player.gamemode.load() != papokin_util::GameMode::Creative
                && player.gamemode.load() != papokin_util::GameMode::Spectator
            {
...
impl Mob for CreakingEntity {
    ...
    fn pre_damage(&self, damage_type: DamageType, _source: Option<&dyn EntityBase>) -> bool {
        ...
        if self.is_heart_bound() && damage_type != DamageType::OUT_OF_WORLD {
            ...
            // 返回 false，使与心绑定的 Creaking 不因普通伤害失去生命值
            return false;
        }
        true
    }
