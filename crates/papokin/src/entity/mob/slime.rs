...
impl SlimeEntity {
    ...
    pub fn check_slime_spawn_rules(world: &World, pos: &BlockPos) -> bool {
        ...
        // TODO: 检查生成原因。如果是刷怪笼，则下方方块有效时应返回 true
        // 目前我们假定为自然生成，因为这是我们正在实现的行为。

        // 沼泽/地表生成
        // TODO: 修复
        // let biome = world.get_biome(pos);
        // if biome.has_tag(&papokin_data::tag::WorldgenBiome::MINECRAFT_ALLOWS_SURFACE_SLIME_SPAWNS)
        //     && pos.0.y > 50
        //     && pos.0.y < 70
        // {
        ...
        let slime_seed = papokin_util::random::seed_slime_chunk(
            chunk_pos.x,
            chunk_pos.y,
            world_seed,
            987_234_911,
        );
        let mut slime_rand = papokin_util::random::legacy_rand::LegacyRand::from_seed(slime_seed);
    ...
    fn post_tick(&self) {
                ...
                .is_ok()
        {
            ...
            for i in 0..count {
                ...
                let new_pos = papokin_util::math::vector3::Vector3::new(
                    pos.x + xd as f64,
                    pos.y + 0.5,
                    pos.z + zd as f64,
                );
