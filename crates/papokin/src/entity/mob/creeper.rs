...
impl CreeperEntity {
    ...
    pub fn set_fuse_speed(&self, speed: i32) {
        ...
        self.mob_entity
            .living_entity
            .entity
            .set_synced_data(papokin_data::tracked_data::creeper::FUSE_ID, VarInt(speed));
    }
...
impl Mob for CreeperEntity {
    ...
    fn mob_on_lightning_strike(
        ...
        if !event.cancelled {
            ...
            self.mob_entity
                .living_entity
                .entity
                .set_synced_data(papokin_data::tracked_data::creeper::CHARGED, true);
        }
        self.mob_entity
            .living_entity
    ...
    fn mob_interact(&self, player: &Arc<Player>, item_stack: &mut ItemStack) -> bool {
        ...
        entity.set_synced_data(papokin_data::tracked_data::creeper::IS_IGNITED, true);
...
impl CreeperEntity {
    ...
    pub fn set_charged(&self, charged: bool) {
        ...
        let entity = &self.mob_entity.living_entity.entity;
        entity.set_synced_data(papokin_data::tracked_data::creeper::CHARGED, charged);
    }
    ...
    pub fn set_ignited(&self, ignited: bool) {
        self.ignited.store(ignited, Ordering::Relaxed);
        let entity = &self.mob_entity.living_entity.entity;
        entity.set_synced_data(papokin_data::tracked_data::creeper::IS_IGNITED, ignited);
    }
