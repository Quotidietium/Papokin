...
use papokin_data::block_properties::EndPortalFrameLikeProperties;
...
use papokin_world::generation::generator::structure_finder::find_nearest_structure;
