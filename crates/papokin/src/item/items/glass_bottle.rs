...
impl ItemBehaviour for GlassBottleItem {
    ...
    fn use_on_block(
        ...
        if item.item_count == 1 && player.gamemode.load() != papokin_util::GameMode::Creative {
            *item = water_bottle;
        } else {
