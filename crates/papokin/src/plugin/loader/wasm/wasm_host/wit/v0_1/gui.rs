...
impl gui::HostGui for PluginHostState {
    async fn new(
        ...
        let size = match window_type {
            papokin_data::screen::WindowType::Generic9x2 => 18,
            papokin_data::screen::WindowType::Generic9x4 => 36,
            papokin_data::screen::WindowType::Generic9x5 => 45,
            papokin_data::screen::WindowType::Generic9x6 => 54,
            papokin_data::screen::WindowType::Generic3x3 => 9,
            papokin_data::screen::WindowType::Generic9x1
            | papokin_data::screen::WindowType::Hopper => 5,
            _ => 27, // 默认
        };
    ...
    async fn clear_items(&mut self, res: Resource<Gui>) -> wasmtime::Result<()> {
        use papokin_inventory::Clearable;
        let gui = self.get_gui_res(&res)?.provider.lock().await;
        gui.inventory.clear();
        Ok(())
    }
