...
pub fn mob_from_resource(
    ...
    state
        ...
        .map_err(|_| wasmtime::Error::msg("无效的生物资源句柄"))
...
pub const fn to_wit_villager_profession(prof_id: i32) -> WitVillagerProfession {
    let prof = match papokin_data::villager::VillagerProfession::from_i32(prof_id) {
        Some(p) => p,
        None => papokin_data::villager::VillagerProfession::None,
    };
    match prof {
        papokin_data::villager::VillagerProfession::None => WitVillagerProfession::None,
        papokin_data::villager::VillagerProfession::Armorer => WitVillagerProfession::Armorer,
        papokin_data::villager::VillagerProfession::Butcher => WitVillagerProfession::Butcher,
        papokin_data::villager::VillagerProfession::Cartographer => {
            WitVillagerProfession::Cartographer
        }
        papokin_data::villager::VillagerProfession::Cleric => WitVillagerProfession::Cleric,
        papokin_data::villager::VillagerProfession::Farmer => WitVillagerProfession::Farmer,
        papokin_data::villager::VillagerProfession::Fisherman => WitVillagerProfession::Fisherman,
        papokin_data::villager::VillagerProfession::Fletcher => WitVillagerProfession::Fletcher,
        papokin_data::villager::VillagerProfession::Leatherworker => {
            WitVillagerProfession::Leatherworker
        }
        papokin_data::villager::VillagerProfession::Librarian => WitVillagerProfession::Librarian,
        papokin_data::villager::VillagerProfession::Mason => WitVillagerProfession::Mason,
        papokin_data::villager::VillagerProfession::Nitwit => WitVillagerProfession::Nitwit,
        papokin_data::villager::VillagerProfession::Shepherd => WitVillagerProfession::Shepherd,
        papokin_data::villager::VillagerProfession::Toolsmith => WitVillagerProfession::Toolsmith,
        papokin_data::villager::VillagerProfession::Weaponsmith => {
...
) -> papokin_data::villager::VillagerProfession {
    match prof {
        WitVillagerProfession::None => papokin_data::villager::VillagerProfession::None,
        WitVillagerProfession::Armorer => papokin_data::villager::VillagerProfession::Armorer,
        WitVillagerProfession::Butcher => papokin_data::villager::VillagerProfession::Butcher,
        WitVillagerProfession::Cartographer => {
            papokin_data::villager::VillagerProfession::Cartographer
        }
        WitVillagerProfession::Cleric => papokin_data::villager::VillagerProfession::Cleric,
        WitVillagerProfession::Farmer => papokin_data::villager::VillagerProfession::Farmer,
        WitVillagerProfession::Fisherman => papokin_data::villager::VillagerProfession::Fisherman,
        WitVillagerProfession::Fletcher => papokin_data::villager::VillagerProfession::Fletcher,
        WitVillagerProfession::Leatherworker => {
            papokin_data::villager::VillagerProfession::Leatherworker
        }
        WitVillagerProfession::Librarian => papokin_data::villager::VillagerProfession::Librarian,
        WitVillagerProfession::Mason => papokin_data::villager::VillagerProfession::Mason,
        WitVillagerProfession::Nitwit => papokin_data::villager::VillagerProfession::Nitwit,
        WitVillagerProfession::Shepherd => papokin_data::villager::VillagerProfession::Shepherd,
        WitVillagerProfession::Toolsmith => papokin_data::villager::VillagerProfession::Toolsmith,
        WitVillagerProfession::Weaponsmith => {
            papokin_data::villager::VillagerProfession::Weaponsmith
        }
    }
...
#[must_use]
pub const fn to_wit_block_direction(dir: papokin_data::BlockDirection) -> WitBlockDirection {
    match dir {
        papokin_data::BlockDirection::Down => WitBlockDirection::Down,
        papokin_data::BlockDirection::Up => WitBlockDirection::Up,
        papokin_data::BlockDirection::North => WitBlockDirection::North,
        papokin_data::BlockDirection::South => WitBlockDirection::South,
        papokin_data::BlockDirection::West => WitBlockDirection::West,
        papokin_data::BlockDirection::East => WitBlockDirection::East,
    }
}

#[must_use]
pub const fn from_wit_block_direction(dir: WitBlockDirection) -> papokin_data::BlockDirection {
    match dir {
        WitBlockDirection::Down => papokin_data::BlockDirection::Down,
        WitBlockDirection::Up => papokin_data::BlockDirection::Up,
        WitBlockDirection::North => papokin_data::BlockDirection::North,
        WitBlockDirection::South => papokin_data::BlockDirection::South,
        WitBlockDirection::West => papokin_data::BlockDirection::West,
        WitBlockDirection::East => papokin_data::BlockDirection::East,
    }
}
...
impl CustomWasmGoal {
    fn invoke(&self, mob: &dyn InternalMob, call: GoalCall) {
        ...
        let run = async move {
            ...
            if let Err(error) = plugin
                        ...
                        let (server_resource, entity_resource, reps) =
                            guest.with(|mut store| {
                                let server = store.data_mut().server.clone().ok_or_else(|| {
                                    wasmtime::Error::msg("Wasm 插件服务器不可用")
                                })?;
                ...
                .await
            {
                tracing::error!(goal_id, %error, "Wasm AI 目标回调失败");
            }
        };
    ...
    /// 调用返回布尔值的目标回调（`can_start` / `should_continue`）。
    ...
    fn invoke_bool(&self, mob: &dyn InternalMob, call: BoolGoalCall) -> bool {
        ...
        match result {
            Ok(allowed) => allowed,
            Err(error) => {
                tracing::error!(goal_id = self.goal_id, %error, "Wasm AI 目标回调失败");
                false
            }
        }
    }
...
impl HostMob for PluginHostState {
    ...
    async fn add_ai_goal(
        ...
        this: Resource<WitMob>,
        priority: u8,
        goal: crate::plugin::loader::wasm::wasm_host::wit::v0_1::papokin::plugin::world::BuiltinAiGoal,
    ) -> wasmtime::Result<()> {
        let entity = mob_from_resource(self, &this)?;
        if let Some(mob) = entity.get_mob() {
            let mob_entity = mob.get_mob_entity();
            match goal {
                crate::plugin::loader::wasm::wasm_host::wit::v0_1::papokin::plugin::world::BuiltinAiGoal::Swim => {
                    mob_entity.add_goal(priority, crate::entity::ai::goal::swim::SwimGoal::default());
                }
                crate::plugin::loader::wasm::wasm_host::wit::v0_1::papokin::plugin::world::BuiltinAiGoal::WanderAround(speed) => {
                    mob_entity.add_goal(priority, crate::entity::ai::goal::wander_around::WanderAroundGoal::new(f64::from(speed)));
                }
                crate::plugin::loader::wasm::wasm_host::wit::v0_1::papokin::plugin::world::BuiltinAiGoal::MeleeAttack(speed) => {
                    mob_entity.add_goal(priority, crate::entity::ai::goal::melee_attack::MeleeAttackGoal::new(f64::from(speed), false));
                }
                crate::plugin::loader::wasm::wasm_host::wit::v0_1::papokin::plugin::world::BuiltinAiGoal::LookAtPlayer(range) => {
                    mob_entity.add_goal(priority, crate::entity::ai::goal::look_at_entity::LookAtEntityGoal::new(
                        ...
                        &papokin_data::entity::EntityType::PLAYER,
                        range,
                        0.02,
                        false,
                    ));
                }
                crate::plugin::loader::wasm::wasm_host::wit::v0_1::papokin::plugin::world::BuiltinAiGoal::LookAround => {
                    mob_entity.add_goal(priority, crate::entity::ai::goal::look_around::RandomLookAroundGoal::default());
                }
                crate::plugin::loader::wasm::wasm_host::wit::v0_1::papokin::plugin::world::BuiltinAiGoal::EscapeDanger(speed) => {
    ...
    async fn add_custom_ai_goal(
        ...
        let Some(plugin) = self.plugin.as_ref().and_then(std::sync::Weak::upgrade) else {
            return Err(wasmtime::Error::msg("插件未激活"));
        };
        let entity = mob_from_resource(self, &this)?;
        if let Some(mob) = entity.get_mob() {
            let mob_entity = mob.get_mob_entity();
                ...
                {
                    {
                        let mut vdata = villager
                            ...
                            .lock()
                            .unwrap_or_else(std::sync::PoisonError::into_inner);
                        vdata.profession = papokin_protocol::codec::var_int::VarInt(
                            from_wit_villager_profession(villager_data.profession) as i32,
                        );
                        vdata.level = papokin_protocol::codec::var_int::VarInt(i32::from(
                            villager_data.level,
                        ));
                    };
                    villager.xp.store(
            ...
            WitMobData::Enderman(enderman_data) => {
                    ...
                    any.downcast_ref::<crate::entity::mob::enderman::EndermanEntity>()
                {
                    enderman.set_carried_block(
                        enderman_data
                            .carried_block_state
                            .and_then(papokin_data::BlockStateId::new),
                    );
...
impl
    crate::plugin::loader::wasm::wasm_host::wit::v0_1::papokin::plugin::world::HostMobWithStore<
        PluginHostState,
