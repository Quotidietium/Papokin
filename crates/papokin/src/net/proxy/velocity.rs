...
use papokin_config::networking::proxy::VelocityConfig;
...
use sha2::Sha256;
use std::sync::Arc;
/// 由 `PaperMC` 开发的 Velocity 代理实现 <https://papermc.io/software/velocity>
/// 遗憾的是，`PaperMC` 并不关心为 Velocity 提供支持的第三方。没有任何文档。
/// 我不得不通过查看 `PaperMC` 的 Velocity 实现来理解代码逻辑：<https://github.com/PaperMC/Paper/blob/0cf731589a3b6923542cdfc36dbcee9c47c51076/paper-server/src/main/java/com/destroystokyo/paper/proxy/VelocityProxy.java>
use std::{
    io::Read,
