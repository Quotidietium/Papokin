...
/// 序列化 Minecraft 1.9 至 1.17.1（含 1.12.2）的区块数据。
...
pub fn write_chunk_data(
    ...
    if version >= &JavaMinecraftVersion::V_1_14 {
        ...
        comp.put("WORLD_SURFACE", papokin_nbt::tag::NbtTag::LongArray(ws_vec));
        comp.put(
            "MOTION_BLOCKING",
            papokin_nbt::tag::NbtTag::LongArray(mb_vec),
        );
        comp.put(
            "MOTION_BLOCKING_NO_LEAVES",
            papokin_nbt::tag::NbtTag::LongArray(mbnl_vec),
        );
    ...
    if version >= &JavaMinecraftVersion::V_1_9_3 {
        ...
        for (pos, nbt) in valid_entities {
            ...
            entity_nbt.put("x", papokin_nbt::tag::NbtTag::Int(pos.0.x));
            entity_nbt.put("y", papokin_nbt::tag::NbtTag::Int(pos.0.y));
            entity_nbt.put("z", papokin_nbt::tag::NbtTag::Int(pos.0.z));
