...
impl ActiveChunkTracker {
    ...
    fn add_area(
        ...
        let offsets = papokin_data::chunk_view_lut::get_chebyshev_square(
    ...
    pub fn update_player(
        ...
        match previous {
            ...
            Some(previous) if previous != area => {
                let prev_offsets = papokin_data::chunk_view_lut::get_chebyshev_square(
                ...
                let curr_offsets = papokin_data::chunk_view_lut::get_chebyshev_square(
                    area.simulation_distance.max(0) as u8,
                );
