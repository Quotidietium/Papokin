...
use papokin_data::entity::{EntityType, MobCategory, SpawnLocation};
use papokin_data::tag::Block::MINECRAFT_PREVENT_MOB_SPAWNING_INSIDE;
use papokin_data::tag::Fluid::{MINECRAFT_LAVA, MINECRAFT_WATER};
use papokin_data::tag::Taggable;
use papokin_data::tag::WorldgenBiome::MINECRAFT_REDUCE_WATER_AMBIENT_SPAWNS;
use papokin_data::{Block, BlockDirection, BlockState, SpawnFloorPredicate};
...
fn is_burning_block(block: &Block) -> bool {
    block.has_tag(&papokin_data::tag::Block::MINECRAFT_FIRE)
