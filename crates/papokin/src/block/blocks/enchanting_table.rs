...
use papokin_data::{Block, BlockState, BlockStateId, translation};
use papokin_inventory::enchanting::enchanting_screen_handler::EnchantingTableScreenHandler;
use papokin_inventory::player::player_inventory::PlayerInventory;
use papokin_inventory::screen_handler::{
    InventoryPlayer, ScreenHandlerFactory, SharedScreenHandler,
};
use papokin_inventory::{Inventory, SimpleInventory};
...
impl ScreenHandlerFactory for EnchantingTableScreenFactory {
    ...
    fn get_display_name(&self) -> TextComponent {
        papokin_macros::translate!(translation::java::CONTAINER_ENCHANT)
    }
}
