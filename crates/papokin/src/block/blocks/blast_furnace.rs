...
impl ScreenHandlerFactory for BlastingFurnaceScreenFactory {
    ...
    fn get_display_name(&self) -> papokin_util::text::TextComponent {
        papokin_macros::translate!(translation::java::CONTAINER_BLAST_FURNACE)
    }
}
    ...
    fn normal_use(&self, args: NormalUseArgs<'_>) -> BlockActionResult {
        if let Some(factory) = self.get_screen_handler_factory(GetScreenHandlerFactoryArgs {
            ...
            args.player.increment_stat(
                ...
                papokin_data::statistic::CustomStatistic::InteractWithBlastFurnace as i32,
                1,
            );
            args.player
