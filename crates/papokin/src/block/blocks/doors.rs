...
use papokin_data::block_properties::Axis;
use papokin_data::block_properties::DoorHinge;
...
use papokin_data::{Block, BlockState, tag};
...
type DoorProperties = papokin_data::block_properties::OakDoorLikeProperties;
