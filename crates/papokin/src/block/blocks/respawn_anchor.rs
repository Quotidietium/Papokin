use papokin_data::block_properties::RespawnAnchorLikeProperties;
use papokin_data::item::Item;
use papokin_data::sound::{Sound, SoundCategory};
use papokin_data::{BlockState, translation};
...
/// 原版 `RespawnAnchorBlock.MAX_CHARGES`。
...
impl BlockBehaviour for RespawnAnchorBlock {
    ...
    fn normal_use(&self, args: NormalUseArgs<'_>) -> BlockActionResult {
        ...
        if props.charges == 0 {
            args.player.send_system_message(&papokin_macros::translate!(
