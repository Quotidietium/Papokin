use papokin_data::block_properties::TargetProperties;
...
impl BlockBehaviour for TargetBlock {
    ...
    fn on_projectile_hit(&self, args: OnProjectileHitArgs<'_>) {
            ...
            && let Some(player) = args.world.get_player_by_id(owner_id)
        {
            player.increment_stat(
                ...
                papokin_data::statistic::CustomStatistic::TargetHit as i32,
                1,
            );
        }
        if !args
    ...
    fn on_place(&self, args: OnPlaceArgs<'_>) -> papokin_data::BlockStateId {
