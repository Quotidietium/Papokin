...
use papokin_data::block_properties::{CrafterLikeProperties, HorizontalFacing, Orientation};
use papokin_data::entity::EntityType;
use papokin_data::item::Item;
use papokin_data::item_stack::ItemStack;
use papokin_data::recipe_remainder::get_recipe_remainder_id;
use papokin_data::translation;
use papokin_data::world::WorldEvent;
use papokin_data::{Block, BlockDirection, BlockStateId, FacingExt};
use papokin_inventory::Inventory;
use papokin_inventory::crafting::crafting_screen_handler::match_crafting_recipe;
use papokin_inventory::generic_container_screen_handler::create_crafter_3x3;
...
impl ScreenHandlerFactory for CrafterScreenFactory {
    ...
    fn get_display_name(&self) -> TextComponent {
        papokin_macros::translate!(translation::java::CONTAINER_CRAFTER)
    }
}
