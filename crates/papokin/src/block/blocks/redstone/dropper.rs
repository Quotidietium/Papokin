...
use papokin_data::{FacingExt, translation};
...
impl ScreenHandlerFactory for DropperScreenFactory {
    ...
    fn get_display_name(&self) -> TextComponent {
        papokin_macros::translate!(translation::java::CONTAINER_DROPPER)
    }
}
    ...
    fn normal_use(&self, args: NormalUseArgs<'_>) -> BlockActionResult {
        if let Some(factory) = self.get_screen_handler_factory(GetScreenHandlerFactoryArgs {
            ...
            args.player.increment_stat(
                ...
                papokin_data::statistic::CustomStatistic::InspectDropper as i32,
                1,
            );
            args.player
