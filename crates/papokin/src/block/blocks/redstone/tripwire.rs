...
use papokin_data::{Block, BlockDirection, BlockStateId, block_properties::HorizontalFacing};
use papokin_macros::pumpkin_block;
use papokin_util::math::{boundingbox::BoundingBox, position::BlockPos};
...
type TripwireProperties = papokin_data::block_properties::TripwireLikeProperties;
type TripwireHookProperties = papokin_data::block_properties::TripwireHookLikeProperties;
