...
/// 检查相邻方块能否支撑朝向它附着的那一面藤蔓。
///
/// 在原版中，对应 `MultifaceBlock.canAttachTo`：面完整/实心，或方块为树叶。
#[must_use]
...
/// 检查 9x3x9 体积内的藤蔓密度是否低于 5（原版 `canSpread`）。
#[must_use]
