...
use papokin_data::{Block, BlockDirection, BlockState, BlockStateId, HorizontalFacingExt, tag};
...
type FenceProperties = papokin_data::block_properties::OakFenceLikeProperties;
