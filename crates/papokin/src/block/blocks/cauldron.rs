...
use papokin_data::block_properties::WaterCauldronLikeProperties;
        ...
        if block_id == BlockId::CAULDRON {
            if item_id == Item::WATER_BUCKET.id {
                ...
                args.player.increment_stat(
                    ...
                    papokin_data::statistic::CustomStatistic::FillCauldron as i32,
                    1,
                );
                ...
                args.player.increment_stat(
                    papokin_data::statistic::StatisticCategory::Custom,
                    papokin_data::statistic::CustomStatistic::UseCauldron as i32,
                    1,
                );
                return BlockActionResult::Success;
            }
        ...
        if block_id == BlockId::WATER_CAULDRON {
            ...
            if props.level > 0 {
                ...
                if args
                    .item_stack
                    .item
                    .has_tag(&papokin_data::tag::Item::MINECRAFT_SHULKER_BOXES)
                    && args.item_stack.item.id != Item::SHULKER_BOX.id
                {
                    ...
                    args.player.increment_stat(
                        papokin_data::statistic::StatisticCategory::Custom,
                        papokin_data::statistic::CustomStatistic::CleanShulkerBox as i32,
                        1,
                    );
                    return BlockActionResult::Success;
                }
                ...
                if args
                    .item_stack
                    .get_data_component::<papokin_data::data_component_impl::BannerPatternsImpl>()
                    .is_some()
                {
                    let next_level = props.level - 1;
                    if next_level > 0 {
                    ...
                    args.item_stack.remove_data_component(
                        papokin_data::data_component::DataComponent::BannerPatterns,
                    );
                    args.player.increment_stat(
                        papokin_data::statistic::StatisticCategory::Custom,
                        papokin_data::statistic::CustomStatistic::CleanBanner as i32,
                        1,
                    );
                    return BlockActionResult::Success;
                }
                ...
                if args
                    .item_stack
                    .get_data_component::<papokin_data::data_component_impl::DyedColorImpl>()
                    .is_some()
                {
                    let next_level = props.level - 1;
                    if next_level > 0 {
                    ...
                    args.item_stack.remove_data_component(
                        papokin_data::data_component::DataComponent::DyedColor,
                    );
                    args.player.increment_stat(
                        papokin_data::statistic::StatisticCategory::Custom,
                        papokin_data::statistic::CustomStatistic::CleanArmor as i32,
                        1,
                    );
                    return BlockActionResult::Success;
                }
