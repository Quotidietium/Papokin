...
use papokin_data::block_properties::{Axis, NoteblockInstrument};
use papokin_data::sound::{Sound, SoundCategory};
use papokin_data::{Block, block_properties::NoteBlockLikeProperties};
...
impl BlockBehaviour for NoteBlock {
    ...
    fn normal_use(&self, args: NormalUseArgs<'_>) -> BlockActionResult {
        ...
        args.player.increment_stat(
            ...
            papokin_data::statistic::CustomStatistic::TuneNoteblock as i32,
            1,
        );
