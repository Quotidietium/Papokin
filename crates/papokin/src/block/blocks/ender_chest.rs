...
use papokin_data::block_properties::LadderLikeProperties;
use papokin_data::{BlockState, BlockStateId, translation};
use papokin_inventory::ViewerCountTracker;
...
impl ScreenHandlerFactory for EnderChestScreenFactory {
    ...
    fn get_display_name(&self) -> TextComponent {
        papokin_macros::translate!(translation::java::CONTAINER_ENDERCHEST)
    }
}
