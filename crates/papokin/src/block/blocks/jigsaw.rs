...
use papokin_data::block_properties::{HorizontalFacing, JigsawLikeProperties, Orientation};
use papokin_data::block_rotation::{Mirror, Rotation};
use papokin_data::{BlockDirection, BlockStateId};
...
impl BlockBehaviour for JigsawBlock {
    ...
    fn mirror(
        ...
        if mirror == Mirror::None {
            return papokin_data::BlockState::from_id(state_id);
        }
        ...
        papokin_data::BlockState::from_id(props.to_state_id(block))
    }
