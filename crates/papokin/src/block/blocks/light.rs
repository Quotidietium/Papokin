...
use papokin_data::block_properties::LightLikeProperties;
...
impl BlockBehaviour for LightBlock {
    ...
    fn can_update_at(&self, args: CanUpdateAtArgs<'_>) -> bool {
        args.player.gamemode.load() == papokin_util::GameMode::Creative
    }

    fn normal_use(&self, args: NormalUseArgs<'_>) -> BlockActionResult {
        if args.player.gamemode.load() == papokin_util::GameMode::Creative {
