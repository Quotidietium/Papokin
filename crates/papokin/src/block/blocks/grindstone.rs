...
use papokin_inventory::grindstone_screen_handler::GrindstoneScreenHandler;
    ...
    fn normal_use(&self, args: NormalUseArgs<'_>) -> BlockActionResult {
        if let Some(factory) = self.get_screen_handler_factory(GetScreenHandlerFactoryArgs {
            ...
            args.player.increment_stat(
                ...
                papokin_data::statistic::CustomStatistic::InteractWithGrindstone as i32,
                1,
            );
            args.player
...
impl ScreenHandlerFactory for GrindstoneScreenFactory {
    ...
    fn get_display_name(&self) -> TextComponent {
        papokin_macros::translate!(translation::java::CONTAINER_GRINDSTONE_TITLE)
    }
}
