...
use papokin_data::block_properties::{BlockProperties, HorizontalFacing};
...
impl_segment_properties!(
    papokin_data::block_properties::PinkPetalsLikeProperties,
    flower_amount
);
impl_segment_properties!(
    papokin_data::block_properties::LeafLitterLikeProperties,
    segment_amount
);
