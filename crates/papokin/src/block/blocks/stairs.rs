...
use papokin_data::block_properties::Half;
use papokin_data::block_properties::HorizontalFacing;
use papokin_data::block_properties::StairsShape;
use papokin_data::tag::Taggable;
use papokin_data::{Block, BlockDirection, BlockState, BlockStateId, Mirror, Rotation, tag};
...
type StairsProperties = papokin_data::block_properties::WhiteWoolStairsLikeProperties;
