...
use papokin_data::block_properties::BedPart;
...
const NO_SLEEP_IDS: &[u16] = &[
    papokin_data::entity::EntityType::BLAZE.id,
    papokin_data::entity::EntityType::BOGGED.id,
    papokin_data::entity::EntityType::SKELETON.id,
    papokin_data::entity::EntityType::STRAY.id,
    papokin_data::entity::EntityType::WITHER_SKELETON.id,
    papokin_data::entity::EntityType::BREEZE.id,
    papokin_data::entity::EntityType::CREAKING.id,
    papokin_data::entity::EntityType::CREEPER.id,
    papokin_data::entity::EntityType::DROWNED.id,
    papokin_data::entity::EntityType::ENDERMITE.id,
    papokin_data::entity::EntityType::EVOKER.id,
    papokin_data::entity::EntityType::GIANT.id,
    papokin_data::entity::EntityType::GUARDIAN.id,
    papokin_data::entity::EntityType::ELDER_GUARDIAN.id,
    papokin_data::entity::EntityType::ILLUSIONER.id,
    papokin_data::entity::EntityType::OCELOT.id,
    papokin_data::entity::EntityType::PIGLIN.id,
    papokin_data::entity::EntityType::PIGLIN_BRUTE.id,
    papokin_data::entity::EntityType::PILLAGER.id,
    papokin_data::entity::EntityType::PHANTOM.id,
    papokin_data::entity::EntityType::RAVAGER.id,
    papokin_data::entity::EntityType::SILVERFISH.id,
    papokin_data::entity::EntityType::SPIDER.id,
    papokin_data::entity::EntityType::CAVE_SPIDER.id,
    papokin_data::entity::EntityType::VEX.id,
    papokin_data::entity::EntityType::VINDICATOR.id,
    papokin_data::entity::EntityType::WARDEN.id,
    papokin_data::entity::EntityType::WITCH.id,
    papokin_data::entity::EntityType::WITHER.id,
    papokin_data::entity::EntityType::ZOGLIN.id,
    papokin_data::entity::EntityType::ZOMBIE.id,
    papokin_data::entity::EntityType::ZOMBIE_VILLAGER.id,
    papokin_data::entity::EntityType::HUSK.id,
    papokin_data::entity::EntityType::ENDERMAN.id,
    papokin_data::entity::EntityType::ZOMBIFIED_PIGLIN.id,
];
...
impl StrawBedBlock {
    ...
    fn sleep_refusal(
        ...
        if !world.dimension.bed_rule.can_sleep(world.is_dark_outside()) {
            return Some(papokin_macros::translate!(
    ...
    fn use_bed(
        ...
        player.increment_stat(
            ...
            papokin_data::statistic::CustomStatistic::SleepInStrawBed as i32,
            1,
        );
