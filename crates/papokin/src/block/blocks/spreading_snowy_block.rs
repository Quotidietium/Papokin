...
use papokin_world::lighting::LightEngine;
...
/// 积雪方块的基础逻辑，对应原版 `net.minecraft.world.level.block.SnowyBlock`。
...
/// 雪化方块（如草方块、菌丝体）蔓延的抽象基础逻辑，
/// 与原版 `net.minecraft.world.level.block.SpreadingSnowyBlock` 一致。
...
/// 灰化土方块，对应原版 `net.minecraft.world.level.block.SnowyBlock` 与 `BlockItemIds.PODZOL`。
...
/// 菌丝体方块，对应原版 `net.minecraft.world.level.block.MyceliumBlock`。
