...
use papokin_inventory::cartography_table_screen_handler::CartographyTableScreenHandler;
    ...
    fn normal_use(&self, args: NormalUseArgs<'_>) -> BlockActionResult {
        if let Some(factory) = self.get_screen_handler_factory(GetScreenHandlerFactoryArgs {
            ...
            args.player.increment_stat(
                ...
                papokin_data::statistic::CustomStatistic::InteractWithCartographyTable as i32,
                1,
            );
            args.player
