...
use papokin_data::block_properties::{Axis, CreakingHeartLikeProperties, CreakingHeartState};
...
impl CreakingHeartBlock {
    ...
    fn check_active_logs(
        world: &dyn papokin_world::world::BlockAccessor,
...
impl BlockBehaviour for CreakingHeartBlock {
    fn on_place(&self, args: OnPlaceArgs<'_>) -> BlockStateId {
        ...
        props.axis = match args.direction {
            papokin_data::BlockDirection::North | papokin_data::BlockDirection::South => Axis::Z,
            papokin_data::BlockDirection::East | papokin_data::BlockDirection::West => Axis::X,
            papokin_data::BlockDirection::Up | papokin_data::BlockDirection::Down => Axis::Y,
        };
