...
pub(crate) type PistonProps = papokin_data::block_properties::StickyPistonLikeProperties;
...
impl PistonBlock {
    ...
    pub fn is_movable(
        ...
        match state.piston_behavior {
            papokin_data::block_state::PistonBehavior::Destroy => return can_break,
            papokin_data::block_state::PistonBehavior::Block => return false,
            papokin_data::block_state::PistonBehavior::PushOnly => return dir == piston_dir,
            _ => {}
        }
