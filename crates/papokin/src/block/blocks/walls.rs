...
use papokin_data::block_properties::EastWall;
use papokin_data::block_properties::HorizontalFacing;
use papokin_data::block_properties::NorthWall;
use papokin_data::block_properties::SouthWall;
use papokin_data::block_properties::WestWall;
use papokin_data::tag::Taggable;
use papokin_data::{Block, BlockDirection, BlockState, BlockStateId, tag};
use papokin_macros::pumpkin_block_from_tag;
use papokin_util::math::position::BlockPos;

type FenceGateProperties = papokin_data::block_properties::OakFenceGateLikeProperties;
type FenceLikeProperties = papokin_data::block_properties::OakFenceLikeProperties;
type WallProperties = papokin_data::block_properties::ResinBrickWallLikeProperties;
