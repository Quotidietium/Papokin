...
use papokin_data::block_properties::{NetherWartLikeProperties, blocks_movement};
use papokin_data::dimension::Dimension;
use papokin_data::{Block, BlockDirection, BlockId, BlockState, BlockStateId, Enchantment};
...
/// 返回 `pos` 处的霜冰方块相邻霜冰方块数量是否少于 `limit`。
