...
use papokin_data::fuels::is_fuel;
use papokin_data::item_stack::ItemStack;
use papokin_data::recipes::{CookingRecipeKind, CookingRecipeType};
...
#[must_use]
pub fn can_smelt_item(item: &papokin_data::item::Item, window_type: WindowType) -> bool {
    ...
    papokin_data::recipes::RECIPES_COOKING
        .iter()
