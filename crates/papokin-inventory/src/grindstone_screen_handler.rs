...
use papokin_data::data_component_impl::{EnchantmentsImpl, MaxDamageImpl, StoredEnchantmentsImpl};
use papokin_data::enchantment::Enchantment;
use papokin_data::item::Item;
use papokin_data::item_stack::ItemStack;
use papokin_data::screen::WindowType;
use papokin_data::tag::Enchantment as EnchantmentTag;
    ...
    fn quick_move(&mut self, player: &dyn InventoryPlayer, slot_index: i32) -> ItemStack {
            ...
            && slot.has_stack()
        {
            ...
            if slot_index as usize == Self::RESULT_SLOT {
                ...
                // 输入槽位（0、1）：从砂轮到玩家物品栏（3..39，reversed = false）
                if !self.insert_item(
                    &mut slot_stack,
                    Self::INV_SLOT_START,
                    Self::USE_ROW_SLOT_END,
