...
use crate::plugin::loader::wasm::wasm_host::wit::v0_1::pumpkin::plugin::registry::{
...
impl HostRegistryManager for PluginHostState {
    async fn register_entry(
        ...
        // A frozen registry (plugin loading finished) or a duplicate name is
        // reported as `Err`; registration never panics.
