...
pub mod witch_consume_potion;
pub mod witch_ready_potion;
pub mod witch_throw_potion;
...
pub use witch_consume_potion::*;
pub use witch_ready_potion::*;
pub use witch_throw_potion::*;
