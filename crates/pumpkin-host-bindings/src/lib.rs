...
bindgen!({
    ...
    imports: {
        ...
        "pumpkin:plugin/dragon@0.1.0.[method]dragon-fight.abort-respawn": async | store | trappable,
        "pumpkin:plugin/dragon@0.1.0.[method]dragon-fight.initiate-respawn": async | store | trappable,
        "pumpkin:plugin/dragon@0.1.0.[method]dragon-fight.reset-crystals": async | store | trappable,
        "pumpkin:plugin/dragon@0.1.0.[method]dragon-fight.set-respawn-stage": async | store | trappable,
        "pumpkin:plugin/dragon@0.1.0.[method]dragon-fight.spawn-crystals": async | store | trappable,
        "pumpkin:plugin/dragon@0.1.0.[method]dragon-fight.spawn-exit-portal": async | store | trappable,
        "pumpkin:plugin/dragon@0.1.0.[method]dragon-fight.spawn-gateway": async | store | trappable,
        ...
        "pumpkin:plugin/player@0.1.0.[method]player.damage-by-name": async | store | trappable,
        ...
        "pumpkin:plugin/player@0.1.0.[method]player.teleport-with-flags": async | store | trappable,
        ...
        "pumpkin:plugin/structure@0.1.0.place-structure": async | store | trappable,
        ...
        "pumpkin:plugin/world@0.1.0.[method]entity.teleport-with-flags": async | store | trappable,
        "pumpkin:plugin/world@0.1.0.[method]living-entity.damage": async | store | trappable,
        "pumpkin:plugin/world@0.1.0.[method]living-entity.damage-by-name": async | store | trappable,
        ...
        "pumpkin:plugin/world@0.1.0.[method]world.spawn-entity-from-snapshot": async | store | trappable,
