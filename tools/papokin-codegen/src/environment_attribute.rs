...
pub fn build() -> TokenStream {
    ...
    quote! {
        ...
        /// 在 `period_ticks` 周期内采样采用线性插值的循环浮点关键帧轨道。
        #[must_use]
        ...
        /// 在 `period_ticks` 周期内采样采用阶跃插值（恒定缓动）的循环浮点关键帧轨道。
        #[must_use]
        ...
        /// 在 `period_ticks` 周期内采样循环的布尔关键帧轨道（阶跃函数）。
        #[must_use]
        ...
        /// 在 `period_ticks` 周期内采样循环的月相关键帧轨道。
        #[must_use]
        ...
        /// 在 `period_ticks` 周期内采样循环的活动关键帧轨道。
        #[must_use]
