...
pub fn build_java_mapping() -> String {
    ...
    output.push_str("// Generated by papokin-codegen. Do not edit.\n");
...
fn convert_value(
    ...
    let expr = match type_ident {
        ...
        "Identifier" => match mode {
            MappingMode::Serialize => {
                format!(
                    "papokin_util::identifier::Identifier::try_from({}).unwrap()",
                    src
                )
            }
        ...
        "VarUInt" => match mode {
            MappingMode::Serialize => {
                format!(
                    "papokin_protocol::codec::var_uint::VarUInt({}.try_into().unwrap())",
                    src
                )
            }
            MappingMode::Deserialize | MappingMode::ToWit => {
